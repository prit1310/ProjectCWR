...
const { signUpSchema, loginSchema, bankDetailsSchema, contactUs} = require('../validators/auth-validator');
...
router.route('/contact').post(validate(contactUs),authcontrollers.contactUs);
